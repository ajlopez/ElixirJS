...
exports['parse and evaluate integer hexadecimal integer'] = function (test) {
    ...
    test.strictEqual(result.evaluate(null), 51966);
...
exports['parse and evaluate atom with underscore'] = function (test) {
    var parser = parsers.parser(':foo_bar');
    ...
    test.ok(result);
    test.ok(result.isAtom());
    test.equal(result.name(), "foo_bar");
...
exports['parse and evaluate list expression using cons'] = function (test) {
    var parser = parsers.parser('[1|[2|[3]]]');
